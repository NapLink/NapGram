...
export class MessageUtils {
     ...
     */
    static async populateAtDisplayNames(msg, qqClient) {
     ...
     */
    static isAdmin(userId, instance) {
     ...
     */
    static async replyTG(tgBot, chatId, text, replyTo) {
        try {
            ...
            const params = { linkPreview: { disable: true } };
            if (replyTo) {
