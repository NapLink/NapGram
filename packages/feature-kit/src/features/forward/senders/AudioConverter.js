...
export class AudioConverter {
    logger = getLogger('AudioConverter');
    /**
     * Prepare voice media for Telegram (convert to OGG/Opus)
     */
    async prepareVoiceMedia(file) {
     ...
     */
    async transcodeToOgg(data, sourceName, preferSilk) {
