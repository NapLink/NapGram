import { authRoutes, databaseRoutes, instancesRoutes, logsRoutes, marketplacesRoutes, messagesRoutes, pairsRoutes, pluginsRoutes, settingsRoutes, tokensRoutes, } from '@napgram/web-interfaces';
const routeMap = {
    auth: authRoutes,
...
function resolveRouteList(config) {
