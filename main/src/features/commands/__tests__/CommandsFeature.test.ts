...
vi.mock('../handlers/QQInteractionCommandHandler', () => ({ QQInteractionCommandHandler: vi.fn().mockImplementation(function () { return mockHandler }) }))
vi.mock('../handlers/RefreshCommandHandler', () => ({ RefreshCommandHandler: vi.fn().mockImplementation(function () { return mockHandler }) }))
vi.mock('../handlers/FlagsCommandHandler', () => ({ FlagsCommandHandler: vi.fn().mockImplementation(function () { return mockHandler }) }))
...
vi.mock('../handlers/RequestManagementCommandHandler', () => ({ RequestManagementCommandHandler: vi.fn().mockImplementation(function () { return mockHandler }) }))
...
describe('CommandsFeature', () => {
    ...
    beforeEach(async () => {
        ...
        vi.doMock('../handlers/QQInteractionCommandHandler', () => ({ QQInteractionCommandHandler: handlerMock }))
        vi.doMock('../handlers/RefreshCommandHandler', () => ({ RefreshCommandHandler: handlerMock }))
        vi.doMock('../handlers/FlagsCommandHandler', () => ({ FlagsCommandHandler: handlerMock }))
        ...
        vi.doMock('../handlers/RequestManagementCommandHandler', () => ({ RequestManagementCommandHandler: handlerMock }))
